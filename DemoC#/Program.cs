...
namespace DemoCSharp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            case 1:
                e_Demo      = eDemo.SMTP;
                e_Security  = Smtp.eSecurity.SSL; // requires SSL or TLS!
            ...
            case 2:
                e_Demo      = eDemo.POP3;
                e_Security  = Smtp.eSecurity.SSL; // requires SSL!
            ...
            case 6:
                e_Demo      = eDemo.SMTP;
                e_Security  = Smtp.eSecurity.TLS_opt;
            ...
            case 8:
                e_Demo      = eDemo.SMTP;
                e_Security  = Smtp.eSecurity.TLS_opt;
                s_From      = "John Miller <jmiller@hotmail.com>";
                s_To        = "John Miller <jmiller@hotmail.com>";
                s_Server    = "smtp-mail.outlook.com";
                s_User      = "jmiller@hotmail.com";      
                s_Password  = "TopSecret";
                break;

            case 9:
                e_Demo      = eDemo.POP3;
                e_Security  = Smtp.eSecurity.SSL;
                s_From      = null; // not used
                s_To        = null;
                s_Server    = "pop-mail.outlook.com";
                s_User      = "jmiller@hotmail.com";      
                s_Password  = "TopSecret";
                break;
            ...
            case 10:
                ...
                s_From      = null; // not used
                s_To        = null;
                s_Server    = "imap-mail.outlook.com";
                s_User      = "jmiller@hotmail.com";      
                s_Password  = "TopSecret";
                break;
            ...
            if (s_User.ToLower().Contains("miller"))
            {
                Print(RED, "Before compiling you must enter a valid user, email and password.");
                Console.Read();
                return;
            }
