...
void cEmailParser::GetTo(std::vector<wstring>* pi_Emails, std::vector<wstring>* pi_Names) // = NULL
{
    try
    {
...
void cEmailParser::GetCc(std::vector<wstring>* pi_Emails, std::vector<wstring>* pi_Names) // = NULL
{
    try
    {
...
void cEmailParser::GetFieldTypeAddrList(const char* s8_Field, std::vector<wstring>* pi_Emails, std::vector<wstring>* pi_Names)
{
    try
    {
