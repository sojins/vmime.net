...
public:
    ...
    void    GetTo(std::vector<wstring>* pi_Emails, std::vector<wstring>* pi_Names=NULL);
    void    GetCc(std::vector<wstring>* pi_Emails, std::vector<wstring>* pi_Names=NULL);
...
private:
    ...
    void                GetFieldTypeAddrList(const char* s8_Field, std::vector<wstring>* pi_Emails, std::vector<wstring>* pi_Names);
